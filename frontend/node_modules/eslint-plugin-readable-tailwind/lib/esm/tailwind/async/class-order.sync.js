...
const getClassOrderSync = createSyncFn(workerPath, workerOptions);
export function getClassOrder(request) {
    if (!isSupportedVersion(version.major)) {
        throw new Error(`Unsupported Tailwind CSS version: ${version.major}`);
    }
    return getClassOrderSync(version.major, request);
}
...
//# sourceMappingURL=class-order.sync.js.map