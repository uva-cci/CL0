...
function lintLiterals(ctx, literals) {
    ...
    for (const literal of literals) {
        ...
        collapse: {
            ...
            ctx.report({
                data: {
                    notReadable: (0, better_tailwindcss_utils_utils_js_1.display)(literal.raw),
                    readable: (0, better_tailwindcss_utils_utils_js_1.display)(fixedClasses)
                },
                fix(fixer) {
...
class Line {
    ...
    toString(indent = true) {
        return this.join([
            ...
            (0, better_tailwindcss_utils_quotes_js_1.escapeNestedQuotes)(this.join(this.classes), this.meta.openingQuote ?? this.meta.closingQuote ?? "`"),
...
function augmentMessage(original, options, message) {
    ...
    return (0, better_tailwindcss_utils_utils_js_1.augmentMessageWithWarnings)(message, warnings);
}
