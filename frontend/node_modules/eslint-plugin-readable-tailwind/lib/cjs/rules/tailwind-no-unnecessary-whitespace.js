...
exports.tailwindNoUnnecessaryWhitespace = void 0;
...
exports.tailwindNoUnnecessaryWhitespace = {
...
function lintLiterals(ctx, literals) {
    ...
    for (const literal of literals) {
        ...
        const escapedClasses = (0, readable_tailwind_utils_quotes_js_1.escapeNestedQuotes)(classes.join(""), literal.openingQuote ?? literal.closingQuote ?? "`");
        const fixedClasses = [
