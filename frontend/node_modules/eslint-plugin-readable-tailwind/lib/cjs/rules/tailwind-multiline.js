...
exports.tailwindMultiline = void 0;
...
function lintLiterals(ctx, literals) {
    ...
    for (const literal of literals) {
        ...
        const classChunks = (0, readable_tailwind_utils_utils_js_1.splitClasses)(literal.content);
...
function getOptions(ctx) {
    ...
    const common = (0, readable_tailwind_utils_utils_js_1.getCommonOptions)(ctx);
...
class Line {
    ...
    toString(indent = true) {
        return this.join([
            ...
            (0, readable_tailwind_utils_quotes_js_1.escapeNestedQuotes)(this.join(this.classes), this.meta.openingQuote ?? this.meta.closingQuote ?? "`"),
...
function augmentMessage(original, options, message) {
    ...
    return (0, readable_tailwind_utils_utils_js_1.augmentMessageWithWarnings)(message, warnings);
}
